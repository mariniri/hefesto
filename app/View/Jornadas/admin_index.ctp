...
<div id="contenedor-jornadas">
    ...
    <div class ="col-md-12">
        ...
        <table class="table table-bordered">
			...
			<th><?php echo $this->Paginator->sort('minutoslibres'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($jornada['Jornada']['inicio']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['fin']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['horaInicio']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['horafin']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['total']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['fecha']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['minutoslibres']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['created']); ?>&nbsp;</td>
		<td><?php echo h($jornada['Jornada']['modified']); ?>&nbsp;</td>
		<td>
